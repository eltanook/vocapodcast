...
function AnimatedNumber({ target, suffix }: { target: number; suffix: string }) {
  ...
  return (
    <ScrollReveal 
      ...
      threshold={0.5} 
      once 
      // Usamos el evento de Framer Motion para disparar el contador
...
export function StatsMiniSection() {
  ...
  return (
    <section className="py-8 md:py-12 bg-voca-light-gray dark:bg-voca-blue border-b border-voca-blue/10 dark:border-voca-cream/10 overflow-hidden">
      <div className="container">
        <ScrollRevealGroup className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8" stagger={0.1}>
          {displayStats.map((stat, index) => (
            <ScrollReveal key={index} direction="up" distance={15} className="text-center space-y-2">

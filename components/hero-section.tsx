    ...
    <section className="min-h-[90vh] relative">
      ...
      <div className="relative z-10 container h-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-12 items-center min-h-[90vh] py-4 lg:py-8">
            ...
            <ScrollReveal direction="up" delay={0.2}>
              <div className="space-y-4 lg:space-y-6">
                ...
                <p className="text-sm sm:text-base md:text-lg font-montserrat leading-relaxed text-voca-cream/90">
                  Un espacio de historias y aprendizajes con personajes que inspiran. Exploramos las vocaciones reales
          ...
          {/* Right Column - Video */}
          <ScrollReveal direction="right" delay={0.3} className="order-1 lg:order-2 mb-0 lg:mb-0">

...
export function FloatingActions() {
  ...
  return (
    <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-40 flex flex-col space-y-3 md:space-y-4">
      {/* Spotify Floating Button */}
      <a
        href="https://open.spotify.com/show/4wgIOoUl8EeehNx9UhOeC1"
        target="_blank"
        rel="noopener noreferrer"
        className="w-12 h-12 md:w-14 md:h-14 bg-[#1DB954] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-300 group relative"
      ...
      >
        ...
        <span className="absolute right-16 bg-voca-dark-blue text-voca-cream text-xs px-3 py-1.5 rounded-lg opacity-0 md:group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none shadow-xl border border-white/10 hidden md:block">
          Escuchar en Spotify
        </span>
      </a>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-12 h-12 md:w-14 md:h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-300 group relative"
